...
```json
{
  ...
  "arguments": {
    ...
    "output_dir": "/tmp/video_analysis/my_video"
  }
}
```
...
| `fetching_info` | 获取视频信息 (TikHub) | 16% |
| `downloading` | 下载视频/音频 | 33% |
| `extracting_audio` | ffmpeg 提取音频 | 50% |
| `transcribing` | ASR 转写 | 66% |
| `finalizing` | 生成输出文件 | 83% |
| `completed` | 处理完成 | 100% |
